...
public sealed class RecordingService
{
    ...
    public async Task<bool> AuthorizeArchiveReadAsync(
        RelayPublishAuthRequest request,
        string archiveReaderSecret,
        CancellationToken cancellationToken = default)
    {
        ArgumentNullException.ThrowIfNull(request);
        ...
        if (!string.Equals(request.Action, "read", StringComparison.OrdinalIgnoreCase) ||
            !string.Equals(request.Protocol, "rtmp", StringComparison.OrdinalIgnoreCase) ||
            !string.Equals(request.User, "archive-reader", StringComparison.Ordinal) ||
            string.IsNullOrWhiteSpace(archiveReaderSecret) ||
            !string.Equals(request.Password, archiveReaderSecret, StringComparison.Ordinal))
        {
            return false;
        }
