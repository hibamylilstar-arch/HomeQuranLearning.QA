...
namespace Academy.Infrastructure.Migrations
{
    ...
    [Migration("20260908203901_AddDirectQaAlertEvidence")]
    partial class AddDirectQaAlertEvidence
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Academy.Domain.Entities.QaAlert", b =>
                {
                    ...
                    b.Property<string>("ActualDeviceName")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)");
                    ...
                    b.Property<DateTimeOffset?>("EvidenceDeleteAfterUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<double?>("EvidenceDurationSeconds")
                        .HasColumnType("double precision");

                    b.Property<double?>("EvidenceEndSeconds")
                        .HasColumnType("double precision");

                    b.Property<DateTimeOffset?>("EvidenceEndUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<long?>("EvidenceSizeBytes")
                        .HasColumnType("bigint");

                    b.Property<double?>("EvidenceStartSeconds")
                        .HasColumnType("double precision");

                    b.Property<DateTimeOffset?>("EvidenceStartUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<Guid?>("SourceQaAudioChunkId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("EvidenceDeleteAfterUtc");

                    b.HasIndex("QaRuleId");

                    b.HasIndex("RecordingId");

                    b.HasIndex("SourceQaAudioChunkId");

                    b.ToTable("qa_alerts", (string)null);
                });

            modelBuilder.Entity("Academy.Domain.Entities.QaAudioChunk", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DeviceId", "SessionId", "CaptureId", "SequenceNumber")
                        .IsUnique();

                    b.ToTable("qa_audio_chunks", (string)null);
                });
